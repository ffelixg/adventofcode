...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  3 13:44:24 2023

@author: felix
"""

data = ("""...................305.124................................432..............................................576..313.....514.................
...
for i, line in enumerate(data):
    for j, char in enumerate(line):
        if char.isdigit() or char == ".":
            continue
        for d1, d2 in itertools.product(range(-1, 2), range(-1, 2)):
            if d1 == 0 and d2 == 0 or i+d1 == len1 or i+d1 == -1 or j+d2 == len2 or j+d2 == -1:
                continue
            new_line = data[i+d1]
            start = end = j+d2
            if not new_line[start].isdigit():
                continue
            while start > 0 and new_line[start-1].isdigit():
                start -= 1
            while end < len2 - 1 and new_line[end+1].isdigit():
                end += 1
            number_bds.add((i+d1, (start, end+1)))

print(sum(int(data[line][start:end]) for line, (start, end) in number_bds))
...
for i, line in enumerate(data):
    for j, char in enumerate(line):
        ...
        for d1, d2 in itertools.product(range(-1, 2), range(-1, 2)):
            ...
            number_bds.add((i+d1, (start, end+1)))
        if len(number_bds) == 2:
            result += functools.reduce(int.__mul__, (int(data[line][start:end]) for line, (start, end) in number_bds), 1)
